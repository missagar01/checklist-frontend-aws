...
import { assignTaskInTable, uniqueDepartmentData, uniqueDoerNameData, uniqueGivenByData, uniqueDivisionData } from "../../redux/slice/assignTaskSlice";
...
export default function AssignTask() {
  ...
  const { division } = useSelector((state) => state.assignTask) // NEW
  ...
  useEffect(() => {
    ...
    dispatch(uniqueDivisionData()); // NEW
