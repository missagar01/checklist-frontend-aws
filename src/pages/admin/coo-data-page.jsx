...
import { CheckCircle2, X, Search, History, ArrowLeft, Calendar, Check } from "lucide-react"
...
function AccountDataPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submissionData = selectedItems.map((id) => {
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredAccountData.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={sheetHeaders.length + 2} className="px-6 py-4 text-center text-gray-500">
