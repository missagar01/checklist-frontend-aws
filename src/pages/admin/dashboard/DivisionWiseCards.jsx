...
export default function DivisionWiseCards({ dateRange, userRole, username, designation, division }) {
    ...
    const StatItem = ({ label, countData, value, icon: Icon, color, textColor, division, divisionStats }) => (
        <motion.div
            whileTap={{ scale: 0.96 }}
